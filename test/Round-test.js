...
describe('Round', function() {
  ...
  describe('Take Turn', function() {
    ...
    it('should update turn count', function() {
      const round = new Round()
      const card = new Card(5, "What Denver Brewery makes Princess Yum Yum?", ['Cerebral', 'Denver Beer Co', 'Black Shirt'], 'Denver Beer Co')
      const turn = new Turn('Denver Beer Co', card)
      round.takeTurn(turn)
    ...
    it('should evaluate current guess', function() {
      ...
      const card = new Card(5, "What Denver Brewery makes Princess Yum Yum?", ['Cerebral', 'Denver Beer Co', 'Black Shirt'], 'Denver Beer Co')
      const turn = new Turn('Denver Beer Co', card)
      let result = round.takeTurn(turn)
